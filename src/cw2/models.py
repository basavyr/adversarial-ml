...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_planes, planes, stride=1, activation_fn=F.tanh):
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, activation_fn=F.tanh):
...
# Original ResNet18 factory function (uses F.tanh)
def ResNet18(act_fn=F.tanh):
    return ResNet(BasicBlock, [2, 2, 2, 2], activation_fn=act_fn)
